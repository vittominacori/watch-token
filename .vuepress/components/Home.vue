  ...
  <b-row class="p-0 pt-4">
    <b-col lg="8" offset-lg="2">
      <b-jumbotron bg-variant="light" header-level="4">
        <template slot="header"> WatchToken </template>
        <template slot="lead">
          {{ $site.title }}
        </template>
        <hr class="my-4" />
        <p>
          ...
          Add your Token to DApp browsers or MetaMask both on Ethereum, Binance
          Smart Chain or Polygon Network.
        </p>
        <b-button
          size="sm"
          variant="info"
    ...
    <b-col lg="8" offset-lg="2">
      <b-jumbotron bg-variant="dark" text-variant="light">
        ...
        <p>
          Use Token Generator to create your own Token in less than a minute.
        </p>
        <b-button
          size="sm"
