<template>
  <b-row class="p-0 pt-4">
    <b-col v-if="!loaded && !loading" lg="8" offset-lg="2">
      <b-card
        bg-variant="light"
        :title="`Create your ${tokenType} Token Widget`">
        <p>
          Create a Widget for your <b>{{ tokenType }}</b> Token on
          <b>{{ blockchain }}</b
          >.<br />
          Enter your Token details, create a Widget and share it with your
          users.
        </p>
        <b-form @submit.prevent="getToken" class="mt-3">
          <b-row>
              ...
              <b-form-group label="Network" label-for="network">
                <b-form-select
                  ...
                  <b-form-select-option-group
                    v-for="b in network.blockchains"
                    :label="b">
            ...
            <b-col lg="12">
              <b-form-group label="Token Address" label-for="tokenAddress">
                <b-input-group>
                  <b-form-input
                    name="tokenAddress"
    ...
    <b-col v-if="loaded" lg="8" offset-lg="2">
      <b-card bg-variant="light">
        <b-form @submit.prevent="createTokenPage" class="mt-3">
          <b-row>
            <b-col lg="12">
              <b-form-group label="Address" label-for="tokenAddress">
                <b-form-input
                  id="tokenAddress"
                  name="tokenAddress"
            ...
            <b-col lg="12">
              <b-form-group label="Name" label-for="tokenName">
                <b-form-input
                  id="tokenName"
                  name="tokenName"
            ...
            <b-col lg="12">
              <b-form-group label="Symbol" label-for="tokenSymbol">
                <b-form-input
                  id="tokenSymbol"
                  name="tokenSymbol"
            ...
            <b-col lg="12">
              <b-form-group label="Decimals" label-for="tokenDecimals">
                <b-form-input
                  id="tokenDecimals"
                  name="tokenDecimals"
  ...
  computed: {
    ...
    blockchain() {
      return this.network.current
        ? this.network.current.blockchain
        : 'Ethereum';
    },
  },
  mounted() {
