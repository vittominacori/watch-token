<template>
  <b-navbar toggleable="md" variant="light">
    ...
    <b-navbar-brand to="/"> WatchToken </b-navbar-brand>

    <b-collapse is-nav id="nav_collapse">
      <b-navbar-nav>
        <b-nav-item :href="$withBase('/create/')">Ethereum</b-nav-item>
        <b-nav-item :href="$withBase('/create/?network=bsc_mainnet')"
          >Binance Smart Chain</b-nav-item
        >
        <b-nav-item :href="$withBase('/create/?network=polygon_mainnet')"
          >Polygon</b-nav-item
        >
        <b-nav-item
          :href="
      ...
      <b-navbar-nav class="ml-auto">
        <b-nav-item-dropdown text="Create Token" right>
          ...
          <b-dropdown-item
            ...
            >Binance Smart Chain</b-dropdown-item
          >
          <b-dropdown-item
            target="_blank"
        ...
        <b-nav-item
          target="_blank"
          href="https://vittominacori.medium.com/how-to-add-token-to-metamask-fba11854f6cd">
          <small>About</small>
        </b-nav-item>
      </b-navbar-nav>
    </b-collapse>
